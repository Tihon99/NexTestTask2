...
public class Task2Test {
    ...
    public void countNexignMainPage() {
        ...
        /*
        Важно отметить, что слова считались без учета раскрытий меню и подменю

        Подсчет был с условием того, что пользователь видит на странице
        без дополнительных взаимодействий с интерфейсом

        Также логотип-название компании, находящийся в верхнем левом углу не является текстом,
        но при наведении появляется надпись "Nexign - международный провайдер BSS-решений",
        поэтому предоставил альтернативный вариант подсчета с учетом этого условия
         */
